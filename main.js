...
var InsertTodaySettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Date format").setDesc("The format for the inserted date.").addText((text) => text.setPlaceholder("Enter your format").setValue(this.plugin.settings.format).onChange(async (value) => {
